...
class BKITVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKITParser#liststatements.
    def visitListstatements(self, ctx:BKITParser.ListstatementsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKITParser#noNullListStatements.
    def visitNoNullListStatements(self, ctx:BKITParser.NoNullListStatementsContext):
        return self.visitChildren(ctx)
