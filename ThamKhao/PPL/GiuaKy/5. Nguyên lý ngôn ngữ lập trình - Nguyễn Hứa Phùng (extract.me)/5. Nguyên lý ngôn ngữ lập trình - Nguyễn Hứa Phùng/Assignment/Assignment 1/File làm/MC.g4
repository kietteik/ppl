...
declarations: vardecls | funcdecls;
...
operand: INTLIT | FLOATLIT | BOOLLIT | STRINGLIT | ID | elementArray;

funccall: ID LB paralist_call? RB;
elementArray: ID LSB INTLIT RSB;
paralist_call: para_call (COMMA paralist_call)*;
...
expStmt: exp SEMI;
blockStmt: LP (vardecls | statement)* RP;
