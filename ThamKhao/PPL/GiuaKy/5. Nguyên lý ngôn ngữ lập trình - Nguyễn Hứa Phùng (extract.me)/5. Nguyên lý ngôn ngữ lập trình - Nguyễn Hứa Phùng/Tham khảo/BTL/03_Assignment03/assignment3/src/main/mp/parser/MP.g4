...
decl: var_decl | func_decl | proce_decl;
// Variable Declaration

var_decl: VAR many_var_decl;

many_var_decl: one_var_decl many_var_decl | one_var_decl;

one_var_decl: id_list COLON typeIdentifer SEMI;
...
param_list: (param many_param)?;

many_param: (SEMI param many_param)?;

param: id_list COLON typeIdentifer;

id_list: ID (COMMA ID)*;

//Type
typeIdentifer: primitive_type | array_type;
primitive_type: BOOLEAN | INTEGER | REAL | STRING;

array_type:
	ARRAY LSB sub_intLit DDOT sub_intLit RSB OF primitive_type;
sub_intLit: SUB? int_literal;
//
//
// ..........................................................................................................\\
// ..............................................STATEMENT...................................................\\
...
statement_type:
	...
	| with_statem
	| compound_statem;
many_statement_type: (statement_type many_statement_type)?;
compound_statem: BEGIN many_statement_type END;

assign_statem: (lhs ASSIGN)+ exp SEMI;

lhs: ID | index_exp;

if_statem: IF exp THEN statement_type (ELSE statement_type)?;

for_statem:
	FOR ID ASSIGN exp (TO | DOWNTO) exp DO statement_type;

//WHILE statement -> OK
while_statem: WHILE exp DO statement_type;

// Return statement ->OK
return_statem: RETURN exp? SEMI;

// Return statement ->OK
break_statem: BREAK SEMI;

// CONTINUE statement ->OK
continue_statem: CONTINUE SEMI;

// CALL statement ->OK
call_statem: ID LB (exp (COMMA exp)*)? RB SEMI;

// WITH statement ->OK
with_statem: WITH many_var_decl DO statement_type;
...
exp5: ID | literal | LB exp RB | index_exp | invocation_exp;
